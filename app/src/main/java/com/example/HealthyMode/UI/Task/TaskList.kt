...
//    private val viewModel: Model_view by viewModels { MainViewModelFactory(dao,repository) }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rev.layoutManager =LinearLayoutManager(requireContext())
...
//        dao = TodoDatabase.getDatabase(requireContext())
//        val adapter = Adapter_todo()
//        binding.rev.adapter = adapter.withLoadStateFooter(
